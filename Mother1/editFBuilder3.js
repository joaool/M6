	define([
		...
		return Declare("editFBuilder",[Evented,FBuilder],{
			...
			constructor:function(objEditForm,eventType){
				...
				console.log("entrou no conStructor de EDITFBUILDER3 !!!!");
				//the properties of editFBuilder area mixin of FfBuilder properties and editFBuilder (because of inheritance)
				
				//----------------------------------------------------------------------------------------------
				console.assert((objEditForm),"editFBuilder3.contructor ->objEditForm is undefined or false !!!");
				//----------- debug preparation Area -----------------------------------------------------------
				this.oDbg=new Dbg();
				this.oDbg.setThis("editFBuilder3");//All debugs within this class will belong to "editFBuilder2"	
				//----------------------------------------------------------------------------------------------
