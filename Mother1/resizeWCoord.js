		...
		function(dojo,Declare,Dbg,Win,Lang,Event,Array,On,Topic,Query,DomStyle,DomGeom,DomConstruct,DomClass,Dom,Exchanger,Evented,Widget){
			return Declare("resizeWidget", [Widget,Evented], {
				...
				constructor:function(args){
					...
					this.oDbg=new Dbg();
					this.oDbg.setThis("resizeWCoord");
					...
					//console.log("1-resizeWidget.constructor ------- CONSTRUCTOR !!!!----- L,T,W,H = "+this.targetL+","+this.targetT+","+this.targetW+","+this.targetH);
				...
				postCreate: function() {
					...
					//this.moveHandler=On(dojo.doc,"mousemove", dojo.hitch(this, "_onMouseMove"));
					this.moveHandler=On(Win.doc,"mousemove", dojo.hitch(this, "_onMouseMove"));
				...
				*/
				setCoordinator:function(coordinator){//necessary to set status in ResizeMoveArea -->done in _onMouseDown
				...
				_onMouseDown: function(e) {
					// ---- JO
					this.coordinator.setStatus(true);//informs the coordinator that the leading object is resizeWidget
					//console.log("resizeWidget._onMouseDown THE COORDINATOR IS SET TO RESIZE =>this.coordinator.setStatus(true)");
					var x = e.clientX; 
					var y = e.clientY; 
					// ---- JO
				...
				_onMouseUp: function(e) {
					// ---- JO
					var isResize=this.coordinator.getStatus();//is resize status is commimg from the coordinator (normally ResizeMoveArea....)
					if(this.oDbg.isDbg("_onMouseUp")) this.oDbg.display("User did 'mouse up'. The coordination var isRezise is set to "+isResize);
					if(isResize){
						var x = e.clientX; 
						var y = e.clientY; 
						...
						this.moveHandler.remove();
							...
							if(this.oDbg.isDbg("_onMouseUp")) this.oDbg.display("Next step will emit EVENT 'endResize' ");
							this.emit("endResize",{cancelable:true,abc:"cde"});
						};
